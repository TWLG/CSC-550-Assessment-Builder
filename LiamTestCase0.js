...
async function LiamTestCase0() {
    ...
    await page.screenshot({path: 'LiamTestCases/TestCase0/1.png'}),
    ...
    await Promise.all([
        ...
        await page.screenshot({path: 'LiamTestCases/TestCase0/2.png'}),
        ...
        await page.screenshot({path: 'LiamTestCases/TestCase0/3.png'}),
     ...
     await page.screenshot({path: 'LiamTestCases/TestCase0/4.png'});
        ...
        await fileChooser.accept(['LiamTestCases/TestCase0/empty.zip']);
        await page.waitForTimeout(3000),//depreicated but the other reccomended method didnt work for me
        await page.screenshot({path: 'LiamTestCases/TestCase0/5.png'}),
